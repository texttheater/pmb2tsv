...
translate(rp(Cat, D10, t(_, Token, Atts)), ba(Cat, nil, D1, t(nil, Cat\Cat, Token, Atts))) :-
  !,
  substitute_sub_term(translate, D10, D1).
translate(rp(Cat, D10, rp(rrb, t(rrb, Token2, Atts2), t(_, Token1, Atts1))),
  ba(Cat, nil, D1, ba(Cat\Cat, nil, t(nil, Cat\Cat, Token2, Atts2), t(nil, (Cat\Cat)\(Cat\Cat), Token1, Atts1)))) :-
  !,
  substitute_sub_term(translate, D10, D1).
translate(rp(Cat, D10, rp(_, t(_, Token2, Atts2), t(rrb, Token1, Atts1))),
  ba(Cat, nil, D1, ba(Cat\Cat, nil, t(nil, Cat\Cat, Token2, Atts2), t(nil, (Cat\Cat)\(Cat\Cat), Token1, Atts1)))) :-
  !,
  substitute_sub_term(translate, D10, D1).
